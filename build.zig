...
pub fn build(b: *std.Build) void {
    ...
    const glfw_dep = b.dependency("glfw", .{}); // Only used by samples
    const imgui_dep = b.dependency("imgui", .{}); // Only used by samples
    const enki_dep = b.dependency("enkits", .{}); // Only used by samples
